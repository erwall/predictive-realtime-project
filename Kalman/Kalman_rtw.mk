...
MODEL                = Kalman
MODULES              = Kalman_data.c Kalman_initialize.c Kalman_terminate.c Kalman.c inv.c mrdivide.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = Kalman_rtw.mk
MATLAB_ROOT          = /opt/matlab/matlab-R2012a
ALT_MATLAB_ROOT      = /opt/matlab/matlab-R2012a
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = /h/d9/z/tfy11mhe/Documents/realtidssystem/project/code_gen
...
ADD_INCLUDES = \
	-I/h/d9/z/tfy11mhe/Documents/realtidssystem/project/code_gen/codegen/lib/Kalman \
	-I/h/d9/z/tfy11mhe/Documents/realtidssystem/project/code_gen/source \
